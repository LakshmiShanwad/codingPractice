...
public class SortStringORINTonBasisofFrequency {
     ...
     */
    public static List<Integer> sortIntonBasisoffrequency(List<Integer> list) {
    ...
    public static void main(String[] args) {
        ...
        Integer[] a = {510, 11474, 5827, 7, 3, 1};
        System.out.println(sortIntonBasisoffrequency(Arrays.asList(a)));
    }
}
